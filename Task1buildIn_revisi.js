...
//find motode mecari element pertama yang memiliki nilai yang sama dengan kodisi
console.log(arr.find(x => x === 'ada'));

//findIndex metode mencari element dengan menampilkan index dari sebuah array
console.log(arr1.findIndex(x => x > 3));

//flat method membuat array baru dengan menggunakan sub array tersebut dan digabungkan secara rekrusif dan kadalaman bisa ditentukan oleh pengguna
console.log(arr2.flat(0));

//splice method menghapus 1 element dan menggantinya dengan element baru
arr.splice(2, 1, 'June')
console.log(arr);

//setYear metode  menetapkan tahun untuk tanggal tertentu menurut waktu universal.
